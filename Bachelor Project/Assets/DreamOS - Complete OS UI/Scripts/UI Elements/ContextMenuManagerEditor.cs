        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    EditorGUILayout.LabelField(new GUIContent("Context Object"), customSkin.FindStyle("Text"), GUILayout.Width(120));
                    EditorGUILayout.PropertyField(contextObject, new GUIContent(""));
                ...
                case 2:
                    ...
                    enableBlur.boolValue = GUILayout.Toggle(enableBlur.boolValue, new GUIContent("Enable Blur"), customSkin.FindStyle("Toggle"));
                    enableBlur.boolValue = GUILayout.Toggle(enableBlur.boolValue, new GUIContent(""), customSkin.FindStyle("Toggle Helper"));
