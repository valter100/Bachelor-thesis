    ...
    public class HorizontalSelector : MonoBehaviour
    {
        ...
        public void SetupSelector()
        {
            if (itemList.Count != 0)
            {
                if (saveValue == true)
                {
                    if (PlayerPrefs.HasKey(selectorTag + "HorizontalSelector") == true)
                        defaultIndex = PlayerPrefs.GetInt(selectorTag + "HorizontalSelector");
                    else
                        PlayerPrefs.SetInt(selectorTag + "HorizontalSelector", defaultIndex);
                }
        ...
        public void PreviousClick()
        {
            if (loopSelection == false)
            {
                if (index != 0)
                {
                    ...
                    if (saveValue == true)
                        PlayerPrefs.SetInt(selectorTag + "HorizontalSelector", index);
                }
            }
